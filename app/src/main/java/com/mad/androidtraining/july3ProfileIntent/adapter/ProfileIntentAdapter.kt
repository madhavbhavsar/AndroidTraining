...
//                val profile = ProfileIntentModel()
//                profile.id =  id
//                profile.name = edtName.text.toString().trim()
//                profile.email = edtEmail.text.toString().trim()
//                profile.mobile = edtMobile.text.toString().trim()
//                profile.password = edtPassword.text.toString().trim()
//                profile.confpassword = edtConfPassword.text.toString().trim()
//                profile.dob = edtDob.text.toString().trim()
//                profile.gender = getGender(btnMale,btnFemale)
//                profile.hobbies = getHobbies(cbSports, cbMusic,cbArt)
